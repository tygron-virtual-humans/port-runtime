...
/**
 * {@link ExpressionGraph} for {@link GOALProgram}s.
 *
 * @author K.Hindriks
 */
@Deprecated
public class GOALProgramGraphGenerator extends
		ExpressionGraphGenerator<GOALProgram> {
	 ...
	 *             When this agent's KRLanguage does not support creating an
	 *             expression graph.
	...
	protected void doCreateGraph(GOALProgram subject) {
		...
		// to the expression graph, only modules.

...
/**
 * Represents an LTL release formula.
 * 
 * @author sungshik
 * 
 */
public final class Release extends Formula {
	...
	/**
	 * Constructs a release formula according to the specified left and right
	 * arguments.
	 * 
	 * @param leftArg
	 *            - The left argument.
	 ...
	 *            - The right argument.
	 */
	public Release(Formula leftArg, Formula rightArg) {
	...
	public boolean equals(Object o) {
		return o instanceof Release && leftArg.equals(((Release) o).leftArg)
				&& rightArg.equals(((Release) o).rightArg);
	}

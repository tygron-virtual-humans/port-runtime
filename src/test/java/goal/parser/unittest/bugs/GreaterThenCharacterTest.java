package goal.parser.unittest.bugs;
 ...
 *
 */
public class GreaterThenCharacterTest extends AbstractUnitTestTest {
	...
	public void test() throws Exception {
		UnitTestResult results = runTest("src/test/resources/goal/parser/unittest/bugs/gtlttoken.test2g");

...
public class PlatformManagerTest {
	...
	@Test
	public void testLoadMASFiles_File() throws GOALParseException {
		...
		assertTrue(mas != null);
		assertEquals(file, mas.getMASFile());
	}

	@Test
	public void testLoadMASFiles_Directory() throws GOALParseException {
